...
1. Сделай таблицу твоей карьерной цели из трех графов/столбцов.  
2. В первой графе (Сегодня -точка А) опиши текущее состояние карьеры.
3. Вторую графу (2-3 года) пока оставь пустой.
4. В третьей графе (4-5 лет) на основе ценностей и колеса карьерного баланса напиши, к каким карьерным целям через 5 лет ты стремишься, что для тебя важно в работе.
