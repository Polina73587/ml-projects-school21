...
1. Create a table of your career goal with three columns.
2. In the first column (Today - Point A), describe your current career status.
3. Leave the second column (2-3 years) empty for now.
4. In the third column (4-5 years), based on your values and career balance wheel, write what career goals you are striving for in 5 years, what is important to you in your work.
